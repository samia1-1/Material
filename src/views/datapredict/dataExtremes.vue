<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      ...
      <el-form-item label="温度" prop="temperature_min">
        <el-input v-model="queryParams.temperature_min" placeholder="请输入预测温度"></el-input>
      </el-form-item>
      <el-form-item label="时间" prop="time_max">
        <el-input v-model="queryParams.time_max" placeholder="请输入预测时间"></el-input>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="持久极限" align="center" prop="enduringLimits"/> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="持久极限" prop="enduringLimits">
          <el-input v-model="queryParams.enduringLimits" placeholder="请输入持久极限"></el-input>
        </el-form-item>
...
import {getListBrands,getListProcessingSystems,searchExetremes} from '@/api/database/dataExtremes.js'
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        // postId:undefined,
        trademark: undefined,
        heat_treatment_system: undefined,
  ...
  methods: {
    ...
    handleQuery() {
      this.loading = true;
      searchExetremes(this.queryParams).then(response => {
