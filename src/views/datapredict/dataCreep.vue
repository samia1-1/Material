<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="预测温度" prop="temperature_predict">
        <el-input v-model="queryParams.temperature_predict" placeholder="请输入预测温度"></el-input>
      </el-form-item>
      <el-form-item label="预测时间" prop="time_prefict">
        <el-input v-model="queryParams.time_predict" placeholder="请输入预测时间"></el-input>
      </el-form-item>
      <el-form-item label="预测应力" prop="stress_predict">
        <el-input v-model="queryParams.stresspredict" placeholder="请输入预测应力"></el-input>
      </el-form-item>

      <el-form-item label="算法类型" prop="algorithm">
        <el-select v-model="queryParams.algorithm" clearable @keyup.enter.native="handleQuery" placeholder="请选择算法类型">
          <el-option
        ...
        <template slot-scope="scope">
            ...
            <el-dialog title="查看数据详情" :visible.sync="dialogTableVisible" v-if="dialogTableVisible">
              <el-table :data="oneDataDetail" label-width="110px">
                ...
                <el-table-column label="时间" align="center" prop="time"/>
                <el-table-column label="应力" align="center" prop="stress"/>
                <el-table-column label="εt_min" align="center" property="εt_min" />
                <el-table-column label="εt_max" align="center" property="εt_max" />
                <el-table-column label="εp_min" align="center" property="εp_min" />
                <el-table-column label="εp_max" align="center" property="εp_max" />
                <el-table-column label="εe_min" align="center" property="εe_min" />
                <el-table-column label="εe_max" align="center" property="εe_max" />
              </el-table>
            </el-dialog>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="热处理制度" prop="treatmentSystem">
          <el-select v-model="queryParams.treatmentSystem" placeholder="热处理制度">
            <el-option v-for="item in ProcessingSystems" :key="item" :label="item" :value="item"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="应力" prop="stress">
          <el-input v-model="queryParams.stress" placeholder="请输入应力"></el-input>
        </el-form-item>
...
import { getListBrands,getListProcessingSystems,searchCreep } from "@/api/database/dataCreep.js";
...
export default {
  ...
  data() {
    return {
      algorithms:['ExtraTreesRegresso','GradientBoostingRegressor','RandomForestRegressor'],
      brands:[],
      ProcessingSystems:[],
      //嵌套表格的 Dialog
      ...
      queryParams: {
        ...
        temperature_predict: undefined,
        time_predict:undefined,
        stress_predict:undefined,
        algorithm: undefined,
      },
      // 表单参数
      form: {},
  ...
  methods: {
    ...
    handleQuery() {
      this.loading = true;
      searchCreep(this.queryParams).then(response => {
