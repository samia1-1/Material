<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      ...
      <el-form-item label="温度" prop="temperature_prodict">
        <el-input v-model="queryParams.temperature_prodict" placeholder="请输入预测温度"></el-input>
      </el-form-item>
      <el-form-item label="应力" prop="stress_prodict">
        <el-input v-model="queryParams.stress_prodict" placeholder="请输入预测应力"></el-input>
      </el-form-item>
