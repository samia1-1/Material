...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'stretch',
        component: () => import('@/views/database/dataShow/dataStretch.vue'),
        meta: { title: '拉伸性能.精铸试棒', icon: 'stretch', affix: true },
      },
      {
        path: 'extreme',
        component: () => import('@/views/database/dataShow/dataExtremes.vue'),
        meta: { title: '持久极限', icon: 'extreme', affix: true },
      },
      {
        path: 'propertie',
        component: () => import('@/views/database/dataShow/dataPropertie.vue'),
  ...
  },
  {
    ...
    component: () => import('@/views/imageRecognition/imageRecognition.vue')
  },
  {
    path: '/datapredict',
